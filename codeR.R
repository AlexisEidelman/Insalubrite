...
datareg <- data[c("risque","insalubre","copropriete","codepostal","parties_cummunes","possedecaves","gardien")]
...
logit=vglm(risque~copropriete + codepostal + parties_cummunes + possedecaves+ gardien,family = multinomial ,data=datareg)
summary(logit)
